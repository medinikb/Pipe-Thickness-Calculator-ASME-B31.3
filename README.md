...
- Corrosion allowance and mill tolerance calculation
...
- Professional Audit Calculation Report
...
minimum required nominal thickness = tm / (1 - mill tolerance)
```
...
7. Open `Show Report`.
8. Click `Print/PDF`.
9. Confirm the PDF report keeps the 2D Section View on page 1.
10. Confirm `Design Input Basis` starts on page 2.
...
- Add controlled batch Excel/CSV calculation workflow.
- Add column-mapping preview for line-list uploads.
- Add formal reviewer/checker approval workflow.
- Add PMS class mapping.
- Add B31.1 and IBR-specific modes if required.
- Add stronger material governance and source traceability.
- Add version-controlled calculation records.
